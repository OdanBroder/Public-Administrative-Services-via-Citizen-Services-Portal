...
const SelfSignedCertificate = () => {
    ...
    const generateCSRAndCertificate = async () => {
        ...
        try {
            ...
            const csrFile = new File([csr], 'bca_request.csr', {
                type: 'text/plain'
            });
            ...
            formData.append('bcaCsr', csrFile);
            formData.append('bcaCert', certificateFile);

            const respone = await api.post('/bca/certificates/self-signed', formData, {
                headers: {
